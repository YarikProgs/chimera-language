...
public sealed interface Stmt extends Node {
    ...
    record WhileStmt(List<Annotation> annotations, Expr cond, Stmt thenStmt, SourcePos pos) implements Stmt {}
    record DoWhileStmt(List<Annotation> annotations, Stmt doStmt, Expr cond, SourcePos pos) implements Stmt {}
